...
window.bootbox = window.bootbox || (function init($, undefined) {
  ...
  var templates = {
    ...
    inputs: {
      ...
      password:
        "<input type='password' class='bootbox-input bootbox-input-text form-control' autocomplete=off type=text />",
      email:
  ...
  exports.alert = function() {
    ...
    options = mergeDialogOptions("alert", ["ok"], ["message", "foo", "callback"], arguments);
  ...
  exports.prompt = function() {
    ...
    options = validateButtons(
      mergeArguments(defaults, arguments, ["title","inputType","callback"]),
      ["cancel", "confirm"]
    );
